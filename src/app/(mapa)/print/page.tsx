...
import PalletSegreged from "./components/palletSegreged";
import { usePrintConfigStore } from "@/features/mapa/store/printConfigStore";
import ColumnConfigModal from "./components/ColumnConfigModal";
import UnitSegreged from "./components/unitSegreged";
...
export default function PrintPage() {
  ...
  const { componentRef, handlePrint } = useMapaPrint({
    headerConfig,
    pageStyle: createTransportPageStyle(transportesUnicos),
    onBeforePrint: async () => {
